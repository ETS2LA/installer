> Originally from [this](https://github.com/ETS2LA/installer/pull/10) PR by [@fred913](https://github.com/fred913). Adapted to the new repo structure with the V2.0 update.
